...
**NOTE:** This post is out of date! The cluster's moved way past `k3s` since this was written. Check out [the up-to-date homelab post](/case-study/homelab/) for where things stand now. Keeping this one up for archival reasons :)
